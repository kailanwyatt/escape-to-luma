...
const HINTS: Record<string,string> = {
  ...
  dockingCollar:'Wait for the cyan hole. Amber means slam — a sealed red plate stops Spark.',
  shearLane:'Stay in the quiet band between the streams — they move opposite ways.',
  rotatingGate:'Throw through the lit pie between the cyan edges — hub is sealed; lead the opening.',
...
const WORLD_EXITS: Record<WorldId, Omit<StoryMoment,'id'>> = {
 containment:{eyebrow:t("storymoments.lockdown_broken"),title:t("storymoments.lockdown_ahead"),body:t('story.retrieval.containment_exit'),instruction:t("storymoments.read_the_next_gates_carefully"),action:t("storymoments.enter_lockdown")},
 ...
 city:{eyebrow:t("storymoments.skybreak"),title:t("storymoments.above_the_city"),body:t("storymoments.spark_reaches_the_highest_roof_weather_towers_rise_through_the_cl"),instruction:t("storymoments.watch_the_gusts_and_moving_rings_as_you_climb"),action:t("storymoments.begin_the_ascent")},
 ascent:{eyebrow:t("storymoments.the_storm"),title:t("storymoments.into_the_storm"),body:t('story.retrieval.ascent_exit'),instruction:t("storymoments.watch_the_weather_systems_ahead"),action:t("storymoments.take_to_the_sky")},
 ...
 orbit:{eyebrow:t("storymoments.orbital_graveyard"),title:t("storymoments.orbital_graveyard_title"),body:t('story.retrieval.orbit_exit'),instruction:t("storymoments.read_the_dead_airlocks_and_wreck_pockets_ahead"),action:t("storymoments.enter_the_graveyard")},
 ...
 moon:{eyebrow:t("storymoments.far_side"),title:t("storymoments.far_side_title"),body:t('story.retrieval.moon_exit'),instruction:t("storymoments.quiet_precision_waits_on_the_far_side"),action:t("storymoments.cross_to_the_far_side")},
 ...
 asteroid_belt:{eyebrow:t("storymoments.collision_course"),title:t("storymoments.the_drift_title"),body:t('story.retrieval.belt_exit'),instruction:t("storymoments.master_long_shots_with_few_cues"),action:t("storymoments.enter_the_drift")},
 ...
 nebula:{visual:'relay',eyebrow:t("storymoments.false_home"),title:t("storymoments.the_null"),body:t('story.retrieval.nebula_exit'),instruction:t("storymoments.escape_the_null_do_not_fight"),action:t("storymoments.face_the_null")},
 the_null:{visual:'signal',eyebrow:t("storymoments.a_familiar_glow"),title:t("storymoments.a_familiar_glow"),body:t('story.retrieval.null_exit'),instruction:t("storymoments.follow_the_familiar_beacon_carefully"),action:t("storymoments.continue_journey")},
 false_home:{visual:'key',eyebrow:t("storymoments.the_key"),title:t("storymoments.ancient_network_title"),body:t('story.retrieval.false_exit'),instruction:t("storymoments.learn_the_synchronized_apertures"),action:t("storymoments.enter_the_network")},
 ancient_network:{visual:'key',eyebrow:t("storymoments.the_key"),title:t("storymoments.the_machine_title"),body:t('story.retrieval.network_exit'),instruction:t("storymoments.controlled_complexity_ahead"),action:t("storymoments.enter_the_machine")},
 ...
 the_signal:{eyebrow:t("storymoments.signal_locked"),title:t("storymoments.homeward_title"),body:t("storymoments.true_coordinates_resolve_across_the_last"),instruction:t("storymoments.no_new_families_only_mastery"),action:t("storymoments.set_course_homeward")},
 homeward:{visual:'signal',eyebrow:t("storymoments.luma"),title:t("storymoments.luma"),body:t('story.retrieval.homeward_exit'),instruction:t("storymoments.cross_the_arrival_gates_lights_gather"),action:t("storymoments.continue_journey")},
