...
export const REFACTORED_CHAPTERS: RefactoredChapterDefinition[] = [
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['elevatorBlocks', 'conveyorGate', 'billboardFlip', 'slidingGate'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['movingRing', 'groundCutLasers', 'wind'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['crosswind', 'pulseRing', 'rapidShutter'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['airlockIris', 'rollingAperture', 'dockingCollar', 'movingRing'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['antennaBoom', 'driftingBlocker', 'retrievalScanner'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['iris', 'movingSafeZone'],
    progressionRole: 'Read opening timing among wreckage',
    homeSignalStrength: 'detectable',
    legacySources: ['orbit'],
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['antennaBoom', 'gravityWells', 'orbiter'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['quietPocket', 'driftingBlocker', 'transitConduit'],
    progressionRole: 'Commit past solid wreck in the dark',
    homeSignalStrength: 'detectable',
    legacySources: ['moon'],
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['orbiter', 'debrisSpiral', 'shearLane', 'driftingBlocker'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['speedCurrent', 'laserGrid'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['falseLightMembrane', 'rollingAperture', 'pulseRing'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['nullTendril', 'nullLash', 'theNull'],
  ...
  },
  {
    ...
    plannedLevelCount: 9,
    obstacleFocus: ['teleportChain', 'laserGrid', 'iris'],
