...
export const REFACTORED_CHAPTERS: RefactoredChapterDefinition[] = [
  {
    ...
    index: 1,
    name: 'Containment',
    subtitle: 'Spark breaks out of the research vessel',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 2,
    name: 'Lockdown',
    subtitle: 'The facility responds and seals routes',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 3,
    name: 'The City',
    subtitle: 'Streets and rooftops toward the signal',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 4,
    name: 'The Ascent',
    subtitle: 'Towers give way to open sky',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 5,
    name: 'The Storm',
    subtitle: 'A violent weather system',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    subtitle: 'Wreckage beyond Earth',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 9,
    name: 'The Moon',
    subtitle: 'Lunar gravity toward the signal',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 11,
    name: 'Asteroid Belt',
    subtitle: 'Natural hazards replace engineered defenses',
    plannedLevelCount: 9,
  ...
  },
  {
    ...
    index: 13,
    name: 'The Nebula',
    subtitle: 'Luminous gas intensifies the signal',
    plannedLevelCount: 9,
