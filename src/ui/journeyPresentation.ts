...
const LOOKS = {
  lab: {image: 'world1.crackEscape' as RuntimeAssetId, accent: '#68E3F2', sky: ['#071827', '#164458', '#04101c'] as const, motif: 'lab'},
  city: {image: 'home.cityGateway' as RuntimeAssetId, accent: '#F3BD76', sky: ['#102538', '#7e6271', '#efb16a'] as const, motif: 'city'},
  cloud: {image: null, accent: '#9ACEEB', sky: ['#10263c', '#427c9e', '#b9dde8'] as const, motif: 'cloud'},
  storm: {image: null, accent: '#7EB8D8', sky: ['#0c1c2c', '#2f5570', '#6a9bb0'] as const, motif: 'cloud'},
  ...
  graveyard: {image: null, accent: '#6F86C8', sky: ['#030910', '#121c30', '#2a3348'] as const, motif: 'orbit'},
  ...
  drift: {image: null, accent: '#A89074', sky: ['#040910', '#1a2434', '#08101b'] as const, motif: 'rocks'},
  nebula: {image: 'world.nebulaBackdrop' as RuntimeAssetId, accent: '#C8A2FB', sky: ['#100d24', '#482469', '#171a36'] as const, motif: 'nebula'},
  theNull: {image: 'world.nebulaBackdrop' as RuntimeAssetId, accent: '#8B6FC0', sky: ['#080612', '#241538', '#0c0a18'] as const, motif: 'nebula'},
  falseHome: {image: 'world.nebulaBackdrop' as RuntimeAssetId, accent: '#D4B4FF', sky: ['#120e28', '#55307a', '#1c2040'] as const, motif: 'nebula'},
  ...
  luma: {image: 'world.homewardBackdrop' as RuntimeAssetId, accent: '#B8F5DC', sky: ['#072028', '#1a5a5c', '#a8e0d8'] as const, motif: 'signal'},
