...
const LOOKS = {
  ...
  earth: {image: 'world.orbitBanner' as RuntimeAssetId, accent: '#E8B86A', sky: ['#040b18', '#1a2a40', '#c48a4a'] as const, motif: 'earth'},
  orbit: {image: 'world.orbitBanner' as RuntimeAssetId, accent: '#839CF4', sky: ['#040b18', '#182640', '#050d1b'] as const, motif: 'orbit'},
  graveyard: {image: 'world.driftBanner' as RuntimeAssetId, accent: '#6F86C8', sky: ['#030910', '#121c30', '#2a3348'] as const, motif: 'ports'},
  moon: {image: 'world.moonBanner' as RuntimeAssetId, accent: '#CAD4DB', sky: ['#030b17', '#172337', '#455360'] as const, motif: 'moon'},
  farSide: {image: 'world.moonBanner' as RuntimeAssetId, accent: '#9AA7B2', sky: ['#02070f', '#0f1826', '#2c3642'] as const, motif: 'moon'},
  rocks: {image: 'world.beltBanner' as RuntimeAssetId, accent: '#B99B7D', sky: ['#060c18', '#263244', '#0a1423'] as const, motif: 'rocks'},
  drift: {image: 'world.beltBanner' as RuntimeAssetId, accent: '#A8C4D8', sky: ['#040910', '#1a2838', '#08101b'] as const, motif: 'current'},
  ...
  falseHome: {image: 'world.homewardBackdrop' as RuntimeAssetId, accent: '#E0C090', sky: ['#1a1408', '#553828', '#2a1c10'] as const, motif: 'relay'},
  ...
  signal: {image: 'world.networkBackdrop' as RuntimeAssetId, accent: '#7EF0FF', sky: ['#04141c', '#174455', '#0a2030'] as const, motif: 'signal'},
  homeward: {image: 'world.homewardBackdrop' as RuntimeAssetId, accent: '#9FE8C7', sky: ['#061629', '#174455', '#8dceca'] as const, motif: 'signal'},
  luma: {image: 'world.lumaBanner' as RuntimeAssetId, accent: '#B8F5DC', sky: ['#072028', '#1a5a5c', '#a8e0d8'] as const, motif: 'reunion'},
