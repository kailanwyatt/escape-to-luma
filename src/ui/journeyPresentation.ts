...
const LOOKS = {
  ...
  earth: {image: 'world.skyGoldBanner' as RuntimeAssetId, accent: '#E8B86A', sky: ['#1a1408', '#3a4a6a', '#c48a4a'] as const, motif: 'earth'},
  ...
  drift: {image: 'world.driftBanner' as RuntimeAssetId, accent: '#A89074', sky: ['#040910', '#1a2434', '#08101b'] as const, motif: 'current'},
