...
export function TypewriterText({text,style,reduceMotion=false}:{text:string;style?:StyleProp<TextStyle>;reduceMotion?:boolean}){
 ...
 return <Pressable accessibilityRole="button" accessibilityLabel={text} accessibilityHint={done?undefined:'Tap to reveal the complete text'} onPress={()=>setRevealed(true)}>
