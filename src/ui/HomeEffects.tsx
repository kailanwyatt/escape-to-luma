...
export function HomeSpark({reduceMotion=false}:{reduceMotion?:boolean}){
 ...
 <Animated.View style={{width:47,height:47,borderRadius:24,backgroundColor:'#8ff5ff',shadowColor:'#54eaff',shadowRadius:24,shadowOpacity:1,shadowOffset:{width:0,height:0},transform:[{scale:energy.interpolate({inputRange:[0,1],outputRange:[.96,1.06]})}]}}><LinearGradient colors={['#ffffff','#f0ffff','#8ff5ff','#29cbed']} style={{width:47,height:47,borderRadius:24,overflow:'hidden',borderColor:'#dcffff',borderWidth:1}}/></Animated.View>
 </View>;
}
