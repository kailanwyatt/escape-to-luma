        ...
        [
          {
            ...
            beamCount: 4,
            spacing: rng.float(1.04, 1.16),
            span: 4.2,
            thickness: 0.06,
            amplitude: rng.float(0.16, 0.22),
            speed: rng.float(0.48, 0.66),
            phaseOffset: rng.float(0.68, 0.84),
            mode: 'static',
          },
        ],
        centeredTarget(),
        ...
        [
          {
            ...
            pattern: 'OPEN_CLOSE',
            beamCount: 4,
            spacing: rng.float(1.08, 1.18),
            span: 4.2,
            thickness: 0.06,
            amplitude: rng.float(0.14, 0.2),
            mode: 'pulse',
            speed: rng.float(0.52, 0.68),
            phaseOffset: 0,
            pulseSpeed: rng.float(0.55, 0.75),
        ...
        [
          {
            ...
            pattern: 'CROSSING',
            beamCount: 6,
            spacing: rng.float(1.12, 1.22),
            span: 4.0,
            thickness: 0.055,
            amplitude: rng.float(0.12, 0.18),
            mode: 'pulse',
            speed: rng.float(0.54, 0.7),
            phaseOffset: rng.float(0.72, 0.9),
            pulseSpeed: rng.float(0.5, 0.7),
